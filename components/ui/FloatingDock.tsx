...
function IconContainer({
  ...
  // Check if this is the theme toggle component
  const isThemeToggle = title === "Theme";
  ...
  // Render differently based on whether it's the theme toggle or a regular link
  return isThemeToggle ? (
    <div>{containerContent}</div>
  ) : (
    <Link href={href}>{containerContent}</Link>
  );
}
